...
import { preparingForAiSearch } from "@portfoleyo/constants/projects/preparingForAiSearch";

export default function PreparingForAiSearch() {
  const project = preparingForAiSearch;
  const allContent = preparingForAiSearch.page.join("");
