export const countryBlockingContent = {
  ...
  page: [
    ...
    `<p>The site’s analytics were showing a high volume of traffic that looked spammy and low quality (likely bots). It wasn’t converting, wasn’t useful, and was making it harder to trust reporting.</p>`,
    ...
    `<h3 class="article-subheading">1) Created and configured Cloudflare</h3>`,
    ...
    `<h3 class="article-subheading">2) Created security rules to block targeted traffic</h3>`,

    `<p>Rather than combining everything into one giant rule, I created separate rules per country. This keeps the setup easy to understand, simpler to maintain and quick to extend later if additional regions need blocking.</p>`,
    ...
    `<h3 class="article-subheading">3) Verified rules were working</h3>`,
    ...
    `<h3 class="article-subheading">Cloudflare Security Rules panel</h3>`,
    ...
    `<h3 class="article-subheading">Cloudflare Events log</h3>`,
    ...
    `<h3 class="article-subheading">Browser DevTools (request headers)</h3>`,
    ...
    `<h3 class="article-subheading">1) VPN testing can be pretty misleading</h3>`,
    ...
    `<h3 class="article-subheading">2) IP blocking is the fastest proof test</h3>`,
    ...
    `<h3 class="article-subheading">3) “equals” vs “is in”</h3>`,
    ...
    `<h3 class="article-subheading">4) DNS changes can feel intimidating</h3>`,
    ...
    `<h3 class="article-subheading">5) Hosted platforms and Cloudflare concerns</h3>`,
